...
| ADR | Decisión | Estado |
| --- | --- | --- |
| [ADR-001](ADR-001-fijar-sdk-0.18.2.md) | Fijar `@qvac/sdk` en 0.18.2 exacto | **reemplazada** por `ADR-007` |
...
| [ADR-007](ADR-007-mover-a-sdk-0.19.md) | Mover a SDK 0.19, no necesitamos `delegate` | aceptada |
