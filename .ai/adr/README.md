...
| ADR | Decisión |
| --- | --- |
| [ADR-001](ADR-001-fijar-sdk-0.19.md) | ~~`@qvac/sdk` 0.19, versión exacta, sin `delegate` ~~ reemplazada por ADR-011 |
...
| [ADR-011](ADR-011-quedarnos-en-sdk-0.18.2.md) | Quedarnos en `@qvac/sdk` 0.18.2 (reemplaza a ADR-001) |
