...
//
// Cuatro pantallas en orden: se entra con un correo, se ve la alerta con lo que
// cuesta atenderla, se elige el monto del crédito y se cargan los documentos.
// El correo no es un login: es la llave del caso de la demo, y la pantalla lo
// dice.
//
