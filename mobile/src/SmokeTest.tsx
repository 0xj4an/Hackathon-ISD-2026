// Smoke test del bloque 0: MedPsy 1.7B en el dispositivo, hasta el primer token.
// Se conserva aparte de la app para poder aislar problemas: si esto falla, el
// problema es el telefono, Expo o el SDK, no nuestro codigo.
// Para usarlo, importarlo desde App.tsx en vez de la app real.
